...
//acesso a imagem do botão
const imgameBotaoTrocaDeTema = document.querySelector(".imagem-botao")
...
botaoAlterarTema.addEventListener("click",() => {
    ...
    //refatorar é codigo, é melhorar o codigo eniminar linhas duplicadas, com menos linhas e maisfacil de entender , aqui foi passo 7 e passo 4, pra isso criando o metedo toggle ele pe pra alternar entre 2 estados
    ...
    if(modoEscuroEstaAtivo) {
       ...
       //passo 8 - trocar a imagem do botão de alterar tema pra sol
       imgameBotaoTrocaDeTema.setAttribute("src", "./src/imagens/sun.png");
    ...
    /* body.classList.add("modo-escuro");*/
     ...
     //passo 5 - trocar a imagem do botão de alterar tema pra lua
     imgameBotaoTrocaDeTema.setAttribute("src", "./src/imagens/moon.png");
